...
public class PedidosController : ControllerBase
{
    ...
    {
        // Evita que intente validar las propiedades de navegación (Menu, Reservacion)
        dto.Menu = null!;
        dto.Reservacion = null!;
        dto.HoraPedido = DateTimeOffset.UtcNow;

        _context.Pedidos.Add(dto);
        await _context.SaveChangesAsync();

        return CreatedAtAction(nameof(GetPedido), new { id = dto.Id }, new
        {
    ...
    public async Task<IActionResult> ActualizarPedido(long id, [FromBody] Pedido dto)
    {
        ...
        pedido.HoraPedido = DateTimeOffset.UtcNow;
